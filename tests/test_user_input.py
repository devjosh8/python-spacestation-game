""" Testet Methoden und Funktionen im Beziehung zum userInput """
...
class TestUserInput(unittest.TestCase):
    ...
    def test_get_integer_input_valid(self, mock_input) -> None:
    ...
    def test_get_integer_input_exit(self, mock_input) -> None:
        """Testet, ob getIntegerInput den Abbruch korrekt behandelt (Eingabe 'x')."""
        result = getIntegerInput("Geben Sie eine Zahl ein: ", 1, 20)
        self.assertEqual(result, -1)
    
    @patch('builtins.input', side_effect=['abc', '15'])
    def test_get_integer_input_invalid_then_valid(self, mock_input) -> None:
    ...
    def test_get_integer_input_out_of_range_then_valid(self, mock_input) -> None:
    ...
    def test_handle_user_input_change_mode(self, mock_input) -> None:
    ...
    def test_handle_user_input_reveal_room(self, mock_print, mock_input) -> None:
    ...
    @patch('builtins.print')
    def test_handle_user_input_joker_room(self, mock_print, mock_input) -> None:
    ...
    @patch('builtins.input', side_effect=['x'])
    @patch('builtins.print')
    def test_handle_user_input_exit(self, mock_print, mock_input) -> None:
