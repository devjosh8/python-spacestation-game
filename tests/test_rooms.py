...
class TestRooms(unittest.TestCase):
    ...
    def test_get_neighbouring_tiles(self):
        ...
        spMap.getTileAt(5, 5).connectRooms(spMap.getTileAt(6, 6))
        ...
        spMap.getTileAt(5, 5).connectRooms(spMap.getTileAt(4, 5))
        spMap.getTileAt(5, 5).connectRooms(spMap.getTileAt(6, 5))
        self.assertTrue(spMap.getTileAt(6, 6) in spMap.getNeighbouringTilesWithConnection(spMap.getTileAt(5, 5)))
